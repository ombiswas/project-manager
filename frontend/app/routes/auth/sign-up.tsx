    ...
    return <div className='min-h-screen flex items-center flex-col justify-center bg-muted/40 p-4'>
        <Card className='w-full max-w-md shadow-x1'>
            <CardHeader className='text-center mb-5'>
                ...
                <CardDescription className='text-muted-foreground text-sm'>Create an account to get started</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
                ...
                <CardFooter className='flex justify-center items-center mt-5'>
                    <div className='flex items-center justify-center'>
                        <p className='text-sm text-muted-foreground'>Already have an account? {" "}<Link to="/sign-in">Sign in</Link></p>
                    </div>
                </CardFooter>
            </CardContent>
        </Card>
